...
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  ...
  '@deepseek-ai/dsh-external-gateway-deployment': ['application.json'],
}
...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  // The desktop IPC bridge node half ships beside the client bundle.
  '@deepseek-ai/dsh-client-connection': ['lib/desktop.js'],
  ...
  // The External Gateway publishes its store/token entrypoints and the
  // versioned protocol and package references used by its clients.
