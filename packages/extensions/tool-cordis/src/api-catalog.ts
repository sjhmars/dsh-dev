...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'async bundleText(id: string, sourceMap: boolean = false): Promise<string | undefined>',
        description: 'Read one entry\'s built client bundle text — the desktop carrier\'s face (the HTTP route reads the same paths for browsers).',
        parameters: [{ name: 'id', description: 'entry id (package name).' }, { name: 'sourceMap', description: 'read the `.map` sibling instead of the bundle.' }],
